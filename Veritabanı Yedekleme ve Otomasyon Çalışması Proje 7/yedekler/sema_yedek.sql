...
\restrict YslnFRcc4CRrke5NMNbY5LyhvUkkvNxQazoSJf4d6VYHPVgxDKgiABlWmUYJLbY
...
--
-- Name: bakim; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA bakim;


ALTER SCHEMA bakim OWNER TO postgres;
...
--
-- Name: musteri_ara_guvensiz(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.musteri_ara_guvensiz(p_isim text) RETURNS TABLE(customer_id integer, first_name character varying, last_name character varying, email character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.musteri_ara_guvensiz(p_isim text) OWNER TO postgres;
...
ALTER TABLE ONLY public.customer FORCE ROW LEVEL SECURITY;
...
--
-- Name: yedekleme_log; Type: TABLE; Schema: bakim; Owner: postgres
--

CREATE TABLE bakim.yedekleme_log (
    yedek_id bigint NOT NULL,
    ...
    boyut_byte bigint,
    durum text NOT NULL,
    CONSTRAINT yedekleme_log_durum_check CHECK ((durum = ANY (ARRAY['BASARILI'::text, 'BASARISIZ'::text])))
);


ALTER TABLE bakim.yedekleme_log OWNER TO postgres;

--
-- Name: yedekleme_log_yedek_id_seq; Type: SEQUENCE; Schema: bakim; Owner: postgres
--

CREATE SEQUENCE bakim.yedekleme_log_yedek_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE bakim.yedekleme_log_yedek_id_seq OWNER TO postgres;

--
-- Name: yedekleme_log_yedek_id_seq; Type: SEQUENCE OWNED BY; Schema: bakim; Owner: postgres
--

ALTER SEQUENCE bakim.yedekleme_log_yedek_id_seq OWNED BY bakim.yedekleme_log.yedek_id;
...
CREATE TABLE public.audit_log (
    ...
    eski_veri jsonb,
    yeni_veri jsonb,
    kullanici text DEFAULT CURRENT_USER NOT NULL,
    islem_zamani timestamp with time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE ONLY public.payment ATTACH PARTITION public.payment_p2022_01 FOR VALUES FROM ('2022-01-01 03:00:00+03') TO ('2022-02-01 03:00:00+03');
...
ALTER TABLE ONLY public.payment ATTACH PARTITION public.payment_p2022_02 FOR VALUES FROM ('2022-02-01 03:00:00+03') TO ('2022-03-01 03:00:00+03');
...
ALTER TABLE ONLY public.payment ATTACH PARTITION public.payment_p2022_03 FOR VALUES FROM ('2022-03-01 03:00:00+03') TO ('2022-04-01 03:00:00+03');
...
ALTER TABLE ONLY public.payment ATTACH PARTITION public.payment_p2022_04 FOR VALUES FROM ('2022-04-01 03:00:00+03') TO ('2022-05-01 03:00:00+03');
...
ALTER TABLE ONLY public.payment ATTACH PARTITION public.payment_p2022_05 FOR VALUES FROM ('2022-05-01 03:00:00+03') TO ('2022-06-01 03:00:00+03');
...
ALTER TABLE ONLY public.payment ATTACH PARTITION public.payment_p2022_06 FOR VALUES FROM ('2022-06-01 03:00:00+03') TO ('2022-07-01 03:00:00+03');
...
ALTER TABLE ONLY public.payment ATTACH PARTITION public.payment_p2022_07 FOR VALUES FROM ('2022-07-01 03:00:00+03') TO ('2022-08-01 03:00:00+03');


--
-- Name: yedekleme_log yedek_id; Type: DEFAULT; Schema: bakim; Owner: postgres
--

ALTER TABLE ONLY bakim.yedekleme_log ALTER COLUMN yedek_id SET DEFAULT nextval('bakim.yedekleme_log_yedek_id_seq'::regclass);
...
--
-- Name: yedekleme_log yedekleme_log_pkey; Type: CONSTRAINT; Schema: bakim; Owner: postgres
--

ALTER TABLE ONLY bakim.yedekleme_log
    ADD CONSTRAINT yedekleme_log_pkey PRIMARY KEY (yedek_id);
...
--
-- Name: idx_payment_amount; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_payment_amount ON ONLY public.payment USING btree (amount);


--
-- Name: idx_payment_customer_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_payment_customer_date ON ONLY public.payment USING btree (customer_id, payment_date);


--
-- Name: idx_rental_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_rental_date ON public.rental USING btree (rental_date);
...
--
-- Name: payment_p2022_01_amount_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_p2022_01_amount_idx ON public.payment_p2022_01 USING btree (amount);
...
--
-- Name: payment_p2022_01_customer_id_payment_date_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_p2022_01_customer_id_payment_date_idx ON public.payment_p2022_01 USING btree (customer_id, payment_date);


--
-- Name: payment_p2022_02_amount_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_p2022_02_amount_idx ON public.payment_p2022_02 USING btree (amount);
...
--
-- Name: payment_p2022_02_customer_id_payment_date_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_p2022_02_customer_id_payment_date_idx ON public.payment_p2022_02 USING btree (customer_id, payment_date);


--
-- Name: payment_p2022_03_amount_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_p2022_03_amount_idx ON public.payment_p2022_03 USING btree (amount);
...
--
-- Name: payment_p2022_03_customer_id_payment_date_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_p2022_03_customer_id_payment_date_idx ON public.payment_p2022_03 USING btree (customer_id, payment_date);


--
-- Name: payment_p2022_04_amount_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_p2022_04_amount_idx ON public.payment_p2022_04 USING btree (amount);
...
--
-- Name: payment_p2022_04_customer_id_payment_date_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_p2022_04_customer_id_payment_date_idx ON public.payment_p2022_04 USING btree (customer_id, payment_date);


--
-- Name: payment_p2022_05_amount_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_p2022_05_amount_idx ON public.payment_p2022_05 USING btree (amount);
...
--
-- Name: payment_p2022_05_customer_id_payment_date_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_p2022_05_customer_id_payment_date_idx ON public.payment_p2022_05 USING btree (customer_id, payment_date);


--
-- Name: payment_p2022_06_amount_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_p2022_06_amount_idx ON public.payment_p2022_06 USING btree (amount);
...
--
-- Name: payment_p2022_06_customer_id_payment_date_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_p2022_06_customer_id_payment_date_idx ON public.payment_p2022_06 USING btree (customer_id, payment_date);


--
-- Name: payment_p2022_07_amount_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_p2022_07_amount_idx ON public.payment_p2022_07 USING btree (amount);


--
-- Name: payment_p2022_07_customer_id_payment_date_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_p2022_07_customer_id_payment_date_idx ON public.payment_p2022_07 USING btree (customer_id, payment_date);
...
--
-- Name: payment_p2022_01_amount_idx; Type: INDEX ATTACH; Schema: public; Owner: postgres
--

ALTER INDEX public.idx_payment_amount ATTACH PARTITION public.payment_p2022_01_amount_idx;


--
-- Name: payment_p2022_01_customer_id_payment_date_idx; Type: INDEX ATTACH; Schema: public; Owner: postgres
--

ALTER INDEX public.idx_payment_customer_date ATTACH PARTITION public.payment_p2022_01_customer_id_payment_date_idx;
...
--
-- Name: payment_p2022_02_amount_idx; Type: INDEX ATTACH; Schema: public; Owner: postgres
--

ALTER INDEX public.idx_payment_amount ATTACH PARTITION public.payment_p2022_02_amount_idx;


--
-- Name: payment_p2022_02_customer_id_payment_date_idx; Type: INDEX ATTACH; Schema: public; Owner: postgres
--

ALTER INDEX public.idx_payment_customer_date ATTACH PARTITION public.payment_p2022_02_customer_id_payment_date_idx;
...
--
-- Name: payment_p2022_03_amount_idx; Type: INDEX ATTACH; Schema: public; Owner: postgres
--

ALTER INDEX public.idx_payment_amount ATTACH PARTITION public.payment_p2022_03_amount_idx;


--
-- Name: payment_p2022_03_customer_id_payment_date_idx; Type: INDEX ATTACH; Schema: public; Owner: postgres
--

ALTER INDEX public.idx_payment_customer_date ATTACH PARTITION public.payment_p2022_03_customer_id_payment_date_idx;
...
--
-- Name: payment_p2022_04_amount_idx; Type: INDEX ATTACH; Schema: public; Owner: postgres
--

ALTER INDEX public.idx_payment_amount ATTACH PARTITION public.payment_p2022_04_amount_idx;


--
-- Name: payment_p2022_04_customer_id_payment_date_idx; Type: INDEX ATTACH; Schema: public; Owner: postgres
--

ALTER INDEX public.idx_payment_customer_date ATTACH PARTITION public.payment_p2022_04_customer_id_payment_date_idx;
...
--
-- Name: payment_p2022_05_amount_idx; Type: INDEX ATTACH; Schema: public; Owner: postgres
--

ALTER INDEX public.idx_payment_amount ATTACH PARTITION public.payment_p2022_05_amount_idx;


--
-- Name: payment_p2022_05_customer_id_payment_date_idx; Type: INDEX ATTACH; Schema: public; Owner: postgres
--

ALTER INDEX public.idx_payment_customer_date ATTACH PARTITION public.payment_p2022_05_customer_id_payment_date_idx;
...
--
-- Name: payment_p2022_06_amount_idx; Type: INDEX ATTACH; Schema: public; Owner: postgres
--

ALTER INDEX public.idx_payment_amount ATTACH PARTITION public.payment_p2022_06_amount_idx;


--
-- Name: payment_p2022_06_customer_id_payment_date_idx; Type: INDEX ATTACH; Schema: public; Owner: postgres
--

ALTER INDEX public.idx_payment_customer_date ATTACH PARTITION public.payment_p2022_06_customer_id_payment_date_idx;
...
--
-- Name: payment_p2022_07_amount_idx; Type: INDEX ATTACH; Schema: public; Owner: postgres
--

ALTER INDEX public.idx_payment_amount ATTACH PARTITION public.payment_p2022_07_amount_idx;


--
-- Name: payment_p2022_07_customer_id_payment_date_idx; Type: INDEX ATTACH; Schema: public; Owner: postgres
--

ALTER INDEX public.idx_payment_customer_date ATTACH PARTITION public.payment_p2022_07_customer_id_payment_date_idx;
...
--
-- Name: customer trg_customer_audit; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_customer_audit AFTER INSERT OR DELETE OR UPDATE ON public.customer FOR EACH ROW EXECUTE FUNCTION public.fn_audit_trigger();
...
--
-- Name: customer admin_politika; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY admin_politika ON public.customer TO db_admin USING (true);
...
--
-- Name: customer raporcu_politika; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY raporcu_politika ON public.customer FOR SELECT TO raporcu USING ((activebool = true));
...
GRANT ALL ON SEQUENCE public.customer_customer_id_seq TO db_admin;
...
GRANT SELECT ON TABLE public.customer TO raporcu;
GRANT SELECT ON TABLE public.customer TO kasiyer;
GRANT ALL ON TABLE public.customer TO db_admin;
GRANT SELECT ON TABLE public.customer TO musteri_destek;


--
-- Name: SEQUENCE actor_actor_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.actor_actor_id_seq TO db_admin;
...
GRANT SELECT ON TABLE public.actor TO raporcu;
GRANT ALL ON TABLE public.actor TO db_admin;
...
GRANT ALL ON SEQUENCE public.category_category_id_seq TO db_admin;
...
GRANT SELECT ON TABLE public.category TO raporcu;
GRANT ALL ON TABLE public.category TO db_admin;


--
-- Name: SEQUENCE film_film_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.film_film_id_seq TO db_admin;
...
GRANT SELECT ON TABLE public.film TO raporcu;
GRANT SELECT ON TABLE public.film TO kasiyer;
GRANT ALL ON TABLE public.film TO db_admin;
...
GRANT SELECT ON TABLE public.film_actor TO raporcu;
GRANT ALL ON TABLE public.film_actor TO db_admin;
...
GRANT SELECT ON TABLE public.film_category TO raporcu;
GRANT ALL ON TABLE public.film_category TO db_admin;
...
GRANT SELECT ON TABLE public.actor_info TO raporcu;
GRANT ALL ON TABLE public.actor_info TO db_admin;
...
GRANT ALL ON SEQUENCE public.address_address_id_seq TO db_admin;
...
GRANT SELECT ON TABLE public.address TO raporcu;
GRANT ALL ON TABLE public.address TO db_admin;
...
GRANT ALL ON SEQUENCE public.city_city_id_seq TO db_admin;
...
GRANT SELECT ON TABLE public.city TO raporcu;
GRANT ALL ON TABLE public.city TO db_admin;
...
GRANT ALL ON SEQUENCE public.country_country_id_seq TO db_admin;
...
GRANT SELECT ON TABLE public.country TO raporcu;
...
GRANT SELECT ON TABLE public.customer_list TO raporcu;
GRANT ALL ON TABLE public.customer_list TO db_admin;
...
GRANT SELECT ON TABLE public.film_list TO raporcu;
GRANT ALL ON TABLE public.film_list TO db_admin;
...
GRANT ALL ON SEQUENCE public.inventory_inventory_id_seq TO db_admin;
...
GRANT SELECT ON TABLE public.inventory TO raporcu;
GRANT SELECT ON TABLE public.inventory TO kasiyer;
GRANT ALL ON TABLE public.inventory TO db_admin;


--
-- Name: SEQUENCE language_language_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.language_language_id_seq TO db_admin;
...
GRANT SELECT ON TABLE public.language TO raporcu;
...
GRANT SELECT ON TABLE public.nicer_but_slower_film_list TO raporcu;
GRANT ALL ON TABLE public.nicer_but_slower_film_list TO db_admin;
...
GRANT ALL ON SEQUENCE public.payment_payment_id_seq TO db_admin;
...
GRANT SELECT ON TABLE public.payment TO raporcu;
GRANT SELECT,INSERT,UPDATE ON TABLE public.payment TO kasiyer;
GRANT ALL ON TABLE public.payment TO db_admin;
GRANT SELECT ON TABLE public.payment TO musteri_destek;


--
-- Name: TABLE payment_p2022_01; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.payment_p2022_01 TO raporcu;
GRANT ALL ON TABLE public.payment_p2022_01 TO db_admin;


--
-- Name: TABLE payment_p2022_02; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.payment_p2022_02 TO raporcu;
GRANT ALL ON TABLE public.payment_p2022_02 TO db_admin;


--
-- Name: TABLE payment_p2022_03; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.payment_p2022_03 TO raporcu;
GRANT ALL ON TABLE public.payment_p2022_03 TO db_admin;


--
-- Name: TABLE payment_p2022_04; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.payment_p2022_04 TO raporcu;
GRANT ALL ON TABLE public.payment_p2022_04 TO db_admin;


--
-- Name: TABLE payment_p2022_05; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.payment_p2022_05 TO raporcu;
GRANT ALL ON TABLE public.payment_p2022_05 TO db_admin;


--
-- Name: TABLE payment_p2022_06; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.payment_p2022_06 TO raporcu;
GRANT ALL ON TABLE public.payment_p2022_06 TO db_admin;


--
-- Name: TABLE payment_p2022_07; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.payment_p2022_07 TO raporcu;
GRANT ALL ON TABLE public.payment_p2022_07 TO db_admin;
...
GRANT SELECT ON TABLE public.pg_stat_statements TO raporcu;
GRANT ALL ON TABLE public.pg_stat_statements TO db_admin;
...
GRANT SELECT ON TABLE public.pg_stat_statements_info TO raporcu;
GRANT ALL ON TABLE public.pg_stat_statements_info TO db_admin;


--
-- Name: SEQUENCE rental_rental_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.rental_rental_id_seq TO db_admin;
...
GRANT SELECT ON TABLE public.rental TO raporcu;
GRANT SELECT,INSERT,UPDATE ON TABLE public.rental TO kasiyer;
GRANT ALL ON TABLE public.rental TO db_admin;
GRANT SELECT ON TABLE public.rental TO musteri_destek;


--
-- Name: TABLE rental_by_category; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.rental_by_category TO raporcu;
GRANT ALL ON TABLE public.rental_by_category TO db_admin;
...
GRANT SELECT ON TABLE public.sales_by_film_category TO raporcu;
GRANT ALL ON TABLE public.sales_by_film_category TO db_admin;


--
-- Name: SEQUENCE staff_staff_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.staff_staff_id_seq TO db_admin;
...
GRANT SELECT ON TABLE public.staff TO raporcu;
GRANT ALL ON TABLE public.staff TO db_admin;


--
-- Name: SEQUENCE store_store_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.store_store_id_seq TO db_admin;
...
GRANT SELECT ON TABLE public.store TO raporcu;
GRANT ALL ON TABLE public.store TO db_admin;
...
GRANT SELECT ON TABLE public.sales_by_store TO raporcu;
GRANT ALL ON TABLE public.sales_by_store TO db_admin;
...
GRANT SELECT ON TABLE public.staff_list TO raporcu;
GRANT ALL ON TABLE public.staff_list TO db_admin;
...
\unrestrict YslnFRcc4CRrke5NMNbY5LyhvUkkvNxQazoSJf4d6VYHPVgxDKgiABlWmUYJLbY
